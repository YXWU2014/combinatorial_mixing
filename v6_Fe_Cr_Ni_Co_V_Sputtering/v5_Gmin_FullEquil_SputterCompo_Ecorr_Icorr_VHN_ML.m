...
T_ML = readtable('MultiTaskModel_NiCrCoVFe_wt_pct_ML_mc_shared_relu.xlsx',"VariableNamingRule","preserve");
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNH_Hardness_FCConly_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNH_Hardness_Uncertainty_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNH_Hardness_UpperConfidenceBound_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNH_Hardness_UpperConfidenceBound_FCConly_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNC_Corrosion_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNC_Corrosion_FCConly_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNC_Corrosion_Uncertainty_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNC_Corrosion_UpperConfidenceBound_', num2str(tk_delta),'K', '.pdf'],'pdf');
...
saveas(gcf, [char(group(i,1)), '-',char(group(i,2)), '-', char(group(i,3)), ...
    '-', char(group(i,4)), '-', char(group(i,5)),'_NNC_Corrosion_UpperConfidenceBound_FCConly_', num2str(tk_delta),'K', '.pdf'],'pdf');
