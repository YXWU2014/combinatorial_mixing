% 20200407
% Calculation of Fe-C-V-Al alloy mn content in cementite at 575C
...
for j=1:length(T)
    ...
    cd('NiCrCoVFe_Scheil_TCHEA4');
    status = copyfile('Scheil_NiCrCoVFe_TCHEA4_template.TCM', [scheil_fname '.TCM']);
